        ...
        <div class="card bg-base-100 shadow-xl">
            <div class="card-body">
                ...
                >
                    ...
                    <div>
                        <label class="label">
                            <span class="label-text">Banner atual</span>
                        </label>

                        <img
                            src="{{ asset('storage/' . $event->banner_path) }}"
                            alt="Banner atual do evento {{ $event->title }}"
                            class="w-full max-h-64 object-cover rounded-lg border border-base-300"
                        >
                    </div>

                    <div>
                        <label class="label" for="banner">
                            <span class="label-text">Novo banner</span>
                        </label>
                        ...
                        <p class="text-sm text-base-content/60 mt-1">
                            Envie uma nova imagem somente se quiser trocar o banner atual.
                        </p>
